...
// functions to serve as the asIBinaryStream interface
...
// functions to serve as the asIStringFactory interface
typedef const void * (*asSTRINGFACTORYGETSTRINGCONSTANT_t)(const char* data, asUINT length, void* param);
typedef int (*asSTRINGFACTORYRELEASESTRINGCONSTANT_t)(const void* str, void* param);
typedef int (*asSTRINGFACTORYGETRAWSTRINGDATA_t)(const void* str, char* data, asUINT* length, void* param);
...
{
public:
	asCStringFactoryC(asSTRINGFACTORYGETSTRINGCONSTANT_t get, asSTRINGFACTORYRELEASESTRINGCONSTANT_t release, asSTRINGFACTORYGETRAWSTRINGDATA_t raw, void* p) { getStringConstant = get; releaseStringConstant = release; getRawStringData = raw; param = p; }

	const void* GetStringConstant(const char* data, asUINT length) { return getStringConstant(data, length, param); };
	int         ReleaseStringConstant(const void* str) { return releaseStringConstant(str, param); };
	int         GetRawStringData(const void* str, char* data, asUINT* length) const { return getRawStringData(str, data, length, param); };

	asSTRINGFACTORYGETSTRINGCONSTANT_t getStringConstant;
	asSTRINGFACTORYRELEASESTRINGCONSTANT_t releaseStringConstant;
	asSTRINGFACTORYGETRAWSTRINGDATA_t getRawStringData;
	void* param;
} g_stringFactory(0, 0, 0, 0);
...
extern "C"
{
	...
	// String factory
	AS_API int                asEngine_RegisterStringFactory(asIScriptEngine* e, const char* datatype, asSTRINGFACTORYGETSTRINGCONSTANT_t get, asSTRINGFACTORYRELEASESTRINGCONSTANT_t release, asSTRINGFACTORYGETRAWSTRINGDATA_t raw, void* param) { g_stringFactory.getStringConstant = get; g_stringFactory.releaseStringConstant = release; g_stringFactory.getRawStringData = raw; return e->RegisterStringFactory(datatype, &g_stringFactory); }
	...
	AS_API void               asEngine_ForwardGCEnumReferences(asIScriptEngine* e, void* ref, asITypeInfo* type) { return e->ForwardGCEnumReferences(ref, type); }
	AS_API void               asEngine_ForwardGCReleaseReferences(asIScriptEngine* e, void* ref, asITypeInfo* type) { return e->ForwardGCReleaseReferences(ref, type); }
	AS_API void               asEngine_SetCircularRefDetectedCallback(asIScriptEngine* e, asCIRCULARREFFUNC_t callback, void* param) { return e->SetCircularRefDetectedCallback(callback, param); }
	...
	AS_API int                asModule_SaveByteCode(asIScriptModule *m, asBINARYWRITEFUNC_t write, void* param, asBOOL stripDebugInfo) { asCBinaryStreamC b(write, 0, param); return m->SaveByteCode(&b, stripDebugInfo ? true : false); }
	AS_API int                asModule_LoadByteCode(asIScriptModule *m, asBINARYREADFUNC_t read, void* param, asBOOL* wasDebugInfoStripped) { asCBinaryStreamC b(0, read, param); bool _wasDebugInfoStripped; int r = m->LoadByteCode(&b, &_wasDebugInfoStripped); if (wasDebugInfoStripped) *wasDebugInfoStripped = _wasDebugInfoStripped ? asTRUE : asFALSE; return r; }
	...
	AS_API int                asContext_GetVar(asIScriptContext *c, asUINT varIndex, asUINT stackLevel, const char** name, int* typeId, asETypeModifiers* typeModifiers, bool* isVarOnHeap, int* stackOffset)                             { return c->GetVar(varIndex, stackLevel, name, typeId, typeModifiers, isVarOnHeap, stackOffset); }
	...
	// Serialization
	AS_API int asContext_StartDeserialization(asIScriptContext* c) { return c->StartDeserialization(); }
	AS_API int asContext_FinishDeserialization(asIScriptContext* c) { return c->FinishDeserialization(); }
	AS_API int asContext_PushFunction(asIScriptContext* c, asIScriptFunction* func, void* object) { return c->PushFunction(func, object); }
	AS_API int asContext_GetStateRegisters(asIScriptContext* c, asUINT stackLevel, asIScriptFunction** callingSystemFunction, asIScriptFunction** initialFunction, asDWORD* origStackPointer, asDWORD* argumentsSize, asQWORD* valueRegister, void** objectRegister, asITypeInfo** objectTypeRegister) { return c->GetStateRegisters(stackLevel, callingSystemFunction, initialFunction, origStackPointer, argumentsSize, valueRegister, objectRegister, objectTypeRegister); }
	AS_API int asContext_GetCallStateRegisters(asIScriptContext* c, asUINT stackLevel, asDWORD* stackFramePointer, asIScriptFunction** currentFunction, asDWORD* programPointer, asDWORD* stackPointer, asDWORD* stackIndex) { return c->GetCallStateRegisters(stackLevel, stackFramePointer, currentFunction, programPointer, stackPointer, stackIndex);  }
	AS_API int asContext_SetStateRegisters(asIScriptContext* c, asUINT stackLevel, asIScriptFunction* callingSystemFunction, asIScriptFunction* initialFunction, asDWORD origStackPointer, asDWORD argumentsSize, asQWORD valueRegister, void* objectRegister, asITypeInfo* objectTypeRegister) { return c->SetStateRegisters(stackLevel, callingSystemFunction, initialFunction, origStackPointer, argumentsSize, valueRegister, objectRegister, objectTypeRegister); }
	AS_API int asContext_SetCallStateRegisters(asIScriptContext* c, asUINT stackLevel, asDWORD stackFramePointer, asIScriptFunction* currentFunction, asDWORD programPointer, asDWORD stackPointer, asDWORD stackIndex) { return c->SetCallStateRegisters(stackLevel, stackFramePointer, currentFunction, programPointer, stackPointer, stackIndex);  }
	AS_API int asContext_GetArgsOnStackCount(asIScriptContext* c, asUINT stackLevel) { return c->GetArgsOnStackCount(stackLevel); }
	AS_API int asContext_GetArgOnStack(asIScriptContext* c, asUINT stackLevel, asUINT arg, int* typeId, asUINT* flags, void** address) { return c->GetArgOnStack(stackLevel, arg, typeId, flags, address); }
	...
	AS_API asIScriptModule *asTypeInfo_GetModule(const asITypeInfo *o) { return o->GetModule(); }
	...
	AS_API const char *asTypeInfo_GetPropertyDeclaration(const asITypeInfo *o, asUINT index, bool includeNamespace)                        { return o->GetPropertyDeclaration(index, includeNamespace); }
	...
	AS_API asBOOL           asFunction_IsExplicit(const asIScriptFunction* f) { return f->IsExplicit() ? asTRUE : asFALSE; }
	AS_API asBOOL           asFunction_IsProperty(const asIScriptFunction* f) { return f->IsProperty() ? asTRUE : asFALSE; }
	...
	AS_API int              asFunction_GetReturnTypeId(const asIScriptFunction *f, asDWORD *flags)                                               { return f->GetReturnTypeId(flags); }
...
//	virtual asJITFunction    GetJITFunction() const = 0;
	...
	// User data
	AS_API void            *asFunction_SetUserData(asIScriptFunction *f, void *userData, asPWORD type)                                         { return f->SetUserData(userData, type); }
	AS_API void            *asFunction_GetUserData(const asIScriptFunction *f, asPWORD type)                                                   { return f->GetUserData(type); }
