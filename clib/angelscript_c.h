...
//	AS_API asIJITCompiler *   asEngine_GetJITCompiler(asIScriptEngine *e);
	...
	AS_API int                asEngine_RegisterObjectProperty(asIScriptEngine *e, const char *obj, const char *declaration, int byteOffset, int compositeOffset, bool isCompositeIndirect);
	AS_API int                asEngine_RegisterObjectMethod(asIScriptEngine *e, const char *obj, const char *declaration, asFUNCTION_t funcPointer, asDWORD callConv, void *auxiliary, int compositeOffset, bool isCompositeIndirect);
	AS_API int                asEngine_RegisterObjectBehaviour(asIScriptEngine *e, const char *datatype, asEBehaviours behaviour, const char *declaration, asFUNCTION_t funcPointer, asDWORD callConv, void *auxiliary, int compositeOffset, bool isCompositeIndirec);
	...
	// String factory
	AS_API int                asEngine_RegisterStringFactory(asIScriptEngine *e, const char *datatype, asSTRINGFACTORYGETSTRINGCONSTANT_t get, asSTRINGFACTORYRELEASESTRINGCONSTANT_t release, asSTRINGFACTORYGETRAWSTRINGDATA_t raw, void *param);
	...
	AS_API void               asEngine_ForwardGCEnumReferences(asIScriptEngine *e, void *ref, asITypeInfo *type);
	AS_API void               asEngine_ForwardGCReleaseReferences(asIScriptEngine *e, void *ref, asITypeInfo *type);
	AS_API void               asEngine_SetCircularRefDetectedCallback(asIScriptEngine *e, asCIRCULARREFFUNC_t callback, void *param);
	...
	AS_API int                asModule_SaveByteCode(asIScriptModule *m, asBINARYWRITEFUNC_t write, void *param, asBOOL stripDebugInfo);
	AS_API int                asModule_LoadByteCode(asIScriptModule *m, asBINARYREADFUNC_t read, void *param, asBOOL *wasDebugInfoStripped);
	...
	AS_API int                asContext_GetVar(asIScriptContext *c, asUINT varIndex, asUINT stackLevel, const char** name, int* typeId, asETypeModifiers* typeModifiers, bool* isVarOnHeap, int* stackOffset);
	...
	AS_API void *             asContext_GetAddressOfVar(asIScriptContext *c, asUINT varIndex, asUINT stackLevel, bool dontDereference, bool returnAddressOfUnitializedObjects);
	...
	// Serialization
	AS_API int asContext_StartDeserialization(asIScriptContext *c);
	AS_API int asContext_FinishDeserialization(asIScriptContext *c);
	AS_API int asContext_PushFunction(asIScriptContext *c, asIScriptFunction *func, void *object);
	AS_API int asContext_GetStateRegisters(asIScriptContext *c, asUINT stackLevel, asIScriptFunction **callingSystemFunction, asIScriptFunction **initialFunction, asDWORD *origStackPointer, asDWORD *argumentsSize, asQWORD *valueRegister, void **objectRegister, asITypeInfo **objectTypeRegister);
	AS_API int asContext_GetCallStateRegisters(asIScriptContext *c, asUINT stackLevel, asDWORD *stackFramePointer, asIScriptFunction **currentFunction, asDWORD *programPointer, asDWORD *stackPointer, asDWORD *stackIndex);
	AS_API int asContext_SetStateRegisters(asIScriptContext *c, asUINT stackLevel, asIScriptFunction *callingSystemFunction, asIScriptFunction *initialFunction, asDWORD origStackPointer, asDWORD argumentsSize, asQWORD valueRegister, void *objectRegister, asITypeInfo *objectTypeRegister);
	AS_API int asContext_SetCallStateRegisters(asIScriptContext *c, asUINT stackLevel, asDWORD stackFramePointer, asIScriptFunction *currentFunction, asDWORD programPointer, asDWORD stackPointer, asDWORD stackIndex);
	AS_API int asContext_GetArgsOnStackCount(asIScriptContext *c, asUINT stackLevel);
	AS_API int asContext_GetArgOnStack(asIScriptContext *c, asUINT stackLevel, asUINT arg, int* typeId, asUINT *flags, void** address);
	...
	// Miscellaneous
	AS_API asIScriptEngine *asTypeInfo_GetEngine(const asITypeInfo *o);
	AS_API const char      *asTypeInfo_GetConfigGroup(const asITypeInfo *o);
	AS_API asDWORD          asTypeInfo_GetAccessMask(const asITypeInfo *o);
	AS_API asIScriptModule *asTypeInfo_GetModule(const asITypeInfo *o);
	...
	AS_API const char *asTypeInfo_GetPropertyDeclaration(const asITypeInfo *o, asUINT index, bool includeNamespace);
	...
	AS_API asBOOL           asFunction_IsExplicit(const asIScriptFunction *f);
	AS_API asBOOL           asFunction_IsProperty(const asIScriptFunction *f);
	...
	AS_API int              asFunction_GetReturnTypeId(const asIScriptFunction *f, asDWORD *flags);
...
//	virtual asJITFunction    GetJITFunction() const = 0;
	...
	// User data
	AS_API void            *asFunction_SetUserData(asIScriptFunction *f, void *userData, asPWORD type);
	AS_API void            *asFunction_GetUserData(const asIScriptFunction *f, asPWORD type);
